...
// --- TENANT CARD ---
const TenantCard = memo(({ tenant, isTopCard, onOpenGallery, propertyRequirements }: { tenant: any, isTopCard: boolean, onOpenGallery: () => void, propertyRequirements: any }) => {
                            ...
                            <View style={styles.statsRow}>
                                {smokerWarning && (
                                    <View style={styles.warningTag}>
                                        ...
                                        <Text style={styles.warningText}>Smoker</Text>
                                    </View>
                                )}
                                {petWarning && (
                                    <View style={styles.warningTag}>
                                        <Ionicons name="alert-circle" size={14} color="#B91C1C" />
                                        <Text style={styles.warningText}>Has Pets</Text>
                                    </View>
                                )}
                            </View>
                        </View>
                    ...
                    <View style={styles.statsRow}>
                        {smokerMatch ? (
                            <View style={[styles.tag, styles.tagMatch]}>
                                ...
                                <Text style={[styles.tagText, { color: '#059669' }]}>Non-Smoker</Text>
                            </View>
                        ) : (
                        ...
                        {petMatch ? (
                            <View style={[styles.tag, styles.tagMatch]}>
                                ...
                                <Text style={[styles.tagText, { color: '#059669' }]}>No Pets</Text>
                            </View>
                        ) : (
                        ...
                        {tenant.minRooms > 0 && (
                            <View style={styles.tag}>
                                ...
                                <Text style={styles.tagText}>Needs {tenant.minRooms}+ Rooms</Text>
                            </View>
                        )}
                    </View>
            ...
            <MatchOverlay
                ...
                onChat={() => {
                    ...
                    if (currentMatchId && matchedTenant) {
                        ...
                        router.push({
                            pathname: '/chat-room',
                            params: { chatId: currentMatchId, title: name }
                        });
                    } else {
